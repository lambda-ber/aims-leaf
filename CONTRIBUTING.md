...
For discussion on AI use see https://github.com/lambda-ber/aims-leaf/issues/45

# Contributing to this schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to aims-leaf. This guide
...
The aims-leaf team strives to create a
...
Please use the [Issue Tracker](https://github.com/lambda-ber/aims-leaf/issues/) for reporting problems with the schema. 
...
See [Pull Requests](https://github.com/lambda-ber/aims-leaf/pulls/) for all pull requests.
...
- PRs should be reviewed and merged in a timely fashion by the aims-leaf technical leads
...
- Include examples and counter-examples (intentionally invalid examples)
    ...
    - All elements of the aims-leaf must be illustrated with valid and invalid data examples in src/data. New schema elements will not be merged into the main branch until examples are provided
...
- ID patterning and checks
    - ID patterns for new classes should follow conventions found [here](https://lambda-ber.github.io/aims-leaf/identifiers/)

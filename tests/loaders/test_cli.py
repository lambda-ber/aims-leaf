...
from aims_leaf_schema.cli import app
...
class TestCLI:
    ...
    def test_help(self):
        ...
        assert "aims-leaf" in result.output
    ...
    def test_etl_dump_pdb_calls_load_all_with_filters(self, mocker, tmp_path):
        ...
        mocker.patch("aims_leaf_schema.cli.PDBLoader", FakePDBLoader)
        mocker.patch("aims_leaf_schema.cli.BatchLoader", FakeBatchLoader)
        mocker.patch("aims_leaf_schema.cli.logging.FileHandler",
                     side_effect=fake_file_handler)
        mocker.patch("aims_leaf_schema.cli.logging.basicConfig")
    ...
    def test_etl_dump_sasbdb_calls_load_all_with_filters(self, mocker, tmp_path):
        ...
        mocker.patch("aims_leaf_schema.cli.SASBDBLoader", FakeSASBDBLoader)
        mocker.patch("aims_leaf_schema.cli.BatchLoader", FakeBatchLoader)
        mocker.patch("aims_leaf_schema.cli.logging.FileHandler",
                     side_effect=fake_file_handler)
        mocker.patch("aims_leaf_schema.cli.logging.basicConfig")
    ...
    def test_etl_emsl_calls_loader_with_expected_args(self, mocker, tmp_path):
        ...
        mocker.patch("aims_leaf_schema.cli.EMSLLoader", FakeLoader)

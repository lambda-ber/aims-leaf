...
from aims_leaf_schema.loaders.batch import BatchLoader
from aims_leaf_schema.pydantic import Dataset
...
class TestBatchLoader:
    ...
    def test_load_all_concurrent_limits_in_flight_futures(self, mocker, tmp_path):
        ...
        mocker.patch(
            "aims_leaf_schema.loaders.batch.ThreadPoolExecutor", TrackingExecutor
        )
    ...
    def test_load_all_concurrent_rate_limits_submission(self, mocker, tmp_path):
        ...
        mocker.patch("aims_leaf_schema.loaders.batch.time.sleep",

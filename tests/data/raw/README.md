...
This directory contains raw or source data files used for testing and validation of the aims-leaf, particularly for demonstrating metadata extraction and mapping from real experimental data.
...
**Description**: Crystal structure deposited in the Protein Data Bank (PDB entry 9B7F). This structure was collected at NSLS-II and serves as a reference example for demonstrating NSLS2-BER-LAMBDA metadata integration with aims-leaf.
...
**Related Files**:
- Example dataset: `examples/Dataset-nsls2-9B7F.yaml` - aims-leaf representation of this structure's metadata
...
1. **Validation**: Verify that aims-leaf can accurately represent real experimental data
2. **Metadata Extraction**: Test tools that extract metadata from CBF/mmCIF files into aims-leaf format
...
See `examples/Dataset-nsls2-9B7F.yaml` for a complete example of how this mmCIF data is represented in aims-leaf format with full NSLS2 field mappings.

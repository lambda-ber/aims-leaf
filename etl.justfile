...
[group('etl')]
pdb-load entry:
    uv run aims-leaf etl pdb --entry {{entry}}

# List recent PDB entries
[group('etl')]
pdb-list:
    uv run aims-leaf etl list pdb --limit 20
...
pdb-dump-start:
    ...
    nohup uv run aims-leaf etl dump-pdb --output-dir {{pdb_dump_dir}} --rate 2 > {{pdb_dump_dir}}/output.log 2>&1 &
...
pdb-dump-start-fast:
    ...
    nohup uv run aims-leaf etl dump-pdb --output-dir {{pdb_dump_dir}} --rate 5 > {{pdb_dump_dir}}/output.log 2>&1 &
...
[group('etl')]
pdb-dump-retry:
    uv run aims-leaf etl dump-pdb --output-dir {{pdb_dump_dir}} --retry-failed
...
[group('etl')]
sasbdb-load entry:
    uv run aims-leaf etl sasbdb --entry {{entry}}

# List SASBDB entries
[group('etl')]
sasbdb-list:
    uv run aims-leaf etl list sasbdb --limit 20
...
sasbdb-dump-start:
    ...
    nohup uv run aims-leaf etl dump-sasbdb --output-dir {{sasbdb_dump_dir}} --rate 2 > {{sasbdb_dump_dir}}/output.log 2>&1 &
...
sasbdb-dump-start-fast:
    ...
    nohup uv run aims-leaf etl dump-sasbdb --output-dir {{sasbdb_dump_dir}} --rate 5 > {{sasbdb_dump_dir}}/output.log 2>&1 &
...
[group('etl')]
sasbdb-dump-retry:
    uv run aims-leaf etl dump-sasbdb --output-dir {{sasbdb_dump_dir}} --retry-failed
...
[group('etl')]
emsl-load sample:
    uv run aims-leaf etl emsl --sample {{sample}}

# List EMSL transaction IDs for a sample query
[group('etl')]
emsl-list sample:
    uv run aims-leaf etl list emsl --sample {{sample}} --limit 20

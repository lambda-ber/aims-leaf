...
- [Schema Docs](https://lambda-ber.github.io/aims-leaf/)
...
make test
```
This currently runs schema generation checks. Example validation has been removed from the default test path during the ongoing schema refactor.

## Making a New Release

This project uses **dynamic versioning** from git tags. The version is automatically:
1. Set in the Python package metadata
2. Injected into the schema YAML (`src/aims_leaf_schema/schema/aims_leaf_ber_schema.yaml`)
...
2. **Create a GitHub Release:**
   - Go to [Releases](https://github.com/lambda-ber/aims-leaf/releases)

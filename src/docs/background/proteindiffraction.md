# aims-leaf and proteindiffraction.org (IRRMC) Alignment Analysis
...
This document provides a detailed analysis of the alignment between the aims-leaf schema and proteindiffraction.org (IRRMC - Integrated Resource for Reproducibility in Macromolecular Crystallography), examining how aims-leaf can integrate with and complement IRRMC's role as an archive for raw X-ray diffraction data supporting reproducibility in crystallographic research.
...
| Field | Description | aims-leaf Equivalent |
|-------|-------------|------------------------------|
...
## aims-leaf-IRRMC Alignment

### Structural Mapping

| IRRMC Concept | aims-leaf Equivalent | Alignment Notes |
|---------------|------------------------------|-----------------|
...
**aims-leaf**: Comprehensive metadata
...
### IRRMC Data Import to aims-leaf

```python
def import_from_proteindiffraction(project_id):
    """Import IRRMC project metadata into aims-leaf"""
...
aims-leaf can enrich IRRMC data with:
...
Collect diffraction images
         ↓
Record metadata in aims-leaf (ExperimentRun)
```
...
### 4. Publication
```
aims-leaf: Complete workflow record
...
1. **Document Early**: Use aims-leaf during data collection
...
1. **Automated Extraction**
   ...
   - Populate aims-leaf programmatically
...
| aims-leaf | Workflow tracking | Reference | Comprehensive | Multi-technique |
| Zenodo | General archival | ✅ | Variable | Any |

## Conclusion

proteindiffraction.org (IRRMC) and aims-leaf form a **complementary ecosystem** for crystallographic data management:
...
1. Using aims-leaf for complete experimental documentation
...
This integration addresses the data quality challenges identified in the SBDG study by ensuring both raw data (IRRMC) and comprehensive metadata (aims-leaf) are preserved, enabling true reproducibility in macromolecular crystallography.

...
URI: [aimsleaf:DatabaseCrossReference](https://w3id.org/aims-leaf/DatabaseCrossReference)
...
| ---  | ---  |
| self | aimsleaf:DatabaseCrossReference |
| native | aimsleaf:DatabaseCrossReference |

...
URI: [aimsleaf:completeness_high_res_shell_percent](https://w3id.org/aims-leaf/completeness_high_res_shell_percent)
...
| ---  | ---  |
| self | aimsleaf:completeness_high_res_shell_percent |
| native | aimsleaf:completeness_high_res_shell_percent |

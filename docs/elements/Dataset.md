...
URI: [aimsleaf:Dataset](https://w3id.org/aims-leaf/Dataset)
...
```mermaid
 classDiagram
    ...
    click Dataset href "../Dataset/"
      ...
      Dataset : plant_sample_preparations
        
          
    
        
        
        Dataset --> "*" PlantSamplePreparation : plant_sample_preparations
        click PlantSamplePreparation href "../PlantSamplePreparation/"
    

        
      Dataset : plantsamples
        
          
    
        
        
        Dataset --> "*" PlantSample : plantsamples
        click PlantSample href "../PlantSample/"
    

        
      Dataset : sample_datafile_associations
        
          
    
        
        
        Dataset --> "*" SampleDataAssociation : sample_datafile_associations
...
| [plantsamples](plantsamples.md) | * <br/> [PlantSample](PlantSample.md) | All samples across all studies | direct |
| [sample_preparations](sample_preparations.md) | * <br/> [SamplePreparation](SamplePreparation.md) | All sample preparations | direct |
| [plant_sample_preparations](plant_sample_preparations.md) | * <br/> [PlantSamplePreparation](PlantSamplePreparation.md) | All plant specific sample preparations | direct |
...
| [sample_datafile_associations](sample_datafile_associations.md) | * <br/> [SampleDataAssociation](SampleDataAssociation.md) | Links between samples and datafiles (M:N) | direct |
...
| ---  | ---  |
| self | aimsleaf:Dataset |
| native | aimsleaf:Dataset |
...
attributes:
  ...
  sample_preparations:
    ...
    inlined: true
    inlined_as_list: true
  plant_sample_preparations:
    name: plant_sample_preparations
    description: All plant specific sample preparations
    from_schema: https://w3id.org/aims-leaf/
    rank: 1000
    domain_of:
    - Dataset
    range: PlantSamplePreparation
    multivalued: true
    inlined: true
    inlined_as_list: true
  experiment_runs:
...
attributes:
  ...
  plant_sample_preparations:
    ...
    from_schema: https://w3id.org/aims-leaf/
    rank: 1000
    alias: plant_sample_preparations
    owner: Dataset
    domain_of:
    - Dataset
    range: PlantSamplePreparation

...
URI: [aimsleaf:SamplePreparation](https://w3id.org/aims-leaf/SamplePreparation)
...
* [NamedThing](NamedThing.md)
    * **SamplePreparation**
        * [PlantSamplePreparation](PlantSamplePreparation.md)
...
| [sample_id](sample_id.md) | 0..1 <br/> [String](String.md) | Reference to the sample being prepared | direct |
| [preparation_date](preparation_date.md) | 0..1 <br/> [Date](Date.md) | Date of sample preparation | direct |
...
| ---  | ---  |
| self | aimsleaf:SamplePreparation |
| native | aimsleaf:SamplePreparation |

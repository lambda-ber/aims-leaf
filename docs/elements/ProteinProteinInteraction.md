...
URI: [aimsleaf:ProteinProteinInteraction](https://w3id.org/aims-leaf/ProteinProteinInteraction)
...
| ---  | ---  |
| self | aimsleaf:ProteinProteinInteraction |
| native | aimsleaf:ProteinProteinInteraction |

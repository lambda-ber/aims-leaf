...
URI: [aimsleaf:minimum_numeric_value](https://w3id.org/aims-leaf/minimum_numeric_value)
...
| ---  | ---  |
| self | aimsleaf:minimum_numeric_value |
| native | aimsleaf:minimum_numeric_value |

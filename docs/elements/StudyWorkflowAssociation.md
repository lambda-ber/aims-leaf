...
URI: [aimsleaf:StudyWorkflowAssociation](https://w3id.org/aims-leaf/StudyWorkflowAssociation)
...
| ---  | ---  |
| self | aimsleaf:StudyWorkflowAssociation |
| native | aimsleaf:StudyWorkflowAssociation |

...
URI: [aimsleaf:AggregatedProteinView](https://w3id.org/aims-leaf/AggregatedProteinView)
...
| ---  | ---  |
| self | aimsleaf:AggregatedProteinView |
| native | aimsleaf:AggregatedProteinView |

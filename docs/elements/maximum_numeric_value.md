...
URI: [aimsleaf:maximum_numeric_value](https://w3id.org/aims-leaf/maximum_numeric_value)
...
| ---  | ---  |
| self | aimsleaf:maximum_numeric_value |
| native | aimsleaf:maximum_numeric_value |

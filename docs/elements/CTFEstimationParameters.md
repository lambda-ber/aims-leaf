...
URI: [aimsleaf:CTFEstimationParameters](https://w3id.org/aims-leaf/CTFEstimationParameters)
...
| ---  | ---  |
| self | aimsleaf:CTFEstimationParameters |
| native | aimsleaf:CTFEstimationParameters |

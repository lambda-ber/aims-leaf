...
URI: [aimsleaf:ExperimentalConditions](https://w3id.org/aims-leaf/ExperimentalConditions)
...
| ---  | ---  |
| self | aimsleaf:ExperimentalConditions |
| native | aimsleaf:ExperimentalConditions |

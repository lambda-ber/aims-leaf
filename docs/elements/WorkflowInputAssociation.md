...
URI: [aimsleaf:WorkflowInputAssociation](https://w3id.org/aims-leaf/WorkflowInputAssociation)
...
| ---  | ---  |
| self | aimsleaf:WorkflowInputAssociation |
| native | aimsleaf:WorkflowInputAssociation |

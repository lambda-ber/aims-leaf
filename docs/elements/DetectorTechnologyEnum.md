...
URI: [aimsleaf:DetectorTechnologyEnum](https://w3id.org/aims-leaf/DetectorTechnologyEnum)
...
| ion_chamber | None | gas-filled ionchamber |
| sdd | None | Silicon drift detector for fluorescence |
| sili | None | Si(Li) detector for fluorescence |
| hpge | None | HPGe multi-element detector for fluorescence |
| photodiode | None | Photodiode for direct beam or fluorescence detection |
| maia | None | MAIA multi-element detector film |
...
permissible_values:
  ...
  ion_chamber:
    ...
    comments:
    - for incident and transmission direct beam measurmeent
  sdd:
    text: sdd
    description: Silicon drift detector for fluorescence
    comments:
    - used for fluorescence detection in XAS and XRF
  sili:
    text: sili
  ...
  photodiode:
    ...
    comments:
    - used for fluorescence detection or direct beam intensity in XAS and XRF
  maia:
    text: maia
    description: MAIA multi-element detector film
    comments:
    - used for fluorescence detection in XRF

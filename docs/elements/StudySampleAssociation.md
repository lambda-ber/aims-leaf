...
URI: [aimsleaf:StudySampleAssociation](https://w3id.org/aims-leaf/StudySampleAssociation)
...
| ---  | ---  |
| self | aimsleaf:StudySampleAssociation |
| native | aimsleaf:StudySampleAssociation |

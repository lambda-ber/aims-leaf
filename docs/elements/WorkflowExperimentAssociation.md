...
URI: [aimsleaf:WorkflowExperimentAssociation](https://w3id.org/aims-leaf/WorkflowExperimentAssociation)
...
| ---  | ---  |
| self | aimsleaf:WorkflowExperimentAssociation |
| native | aimsleaf:WorkflowExperimentAssociation |

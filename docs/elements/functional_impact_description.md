...
URI: [aimsleaf:functional_impact_description](https://w3id.org/aims-leaf/functional_impact_description)
...
| ---  | ---  |
| self | aimsleaf:functional_impact_description |
| native | aimsleaf:functional_impact_description |

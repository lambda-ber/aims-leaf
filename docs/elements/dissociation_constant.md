...
URI: [aimsleaf:dissociation_constant](https://w3id.org/aims-leaf/dissociation_constant)
...
| ---  | ---  |
| self | aimsleaf:dissociation_constant |
| native | aimsleaf:dissociation_constant |

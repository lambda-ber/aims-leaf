...
URI: [aimsleaf:workflow_experiment_associations](https://w3id.org/aims-leaf/workflow_experiment_associations)
...
| ---  | ---  |
| self | aimsleaf:workflow_experiment_associations |
| native | aimsleaf:workflow_experiment_associations |

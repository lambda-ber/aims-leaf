...
URI: [aimsleaf:WorkflowOutputAssociation](https://w3id.org/aims-leaf/WorkflowOutputAssociation)
...
| ---  | ---  |
| self | aimsleaf:WorkflowOutputAssociation |
| native | aimsleaf:WorkflowOutputAssociation |

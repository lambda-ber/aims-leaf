...
URI: [aimsleaf:Image](https://w3id.org/aims-leaf/Image)
...
| [acquisition_date](acquisition_date.md) | 0..1 <br/> [Date](Date.md) | Date image was acquired | direct |

...
URI: [aimsleaf:MeasurementConditions](https://w3id.org/aims-leaf/MeasurementConditions)
...
| ---  | ---  |
| self | aimsleaf:MeasurementConditions |
| native | aimsleaf:MeasurementConditions |

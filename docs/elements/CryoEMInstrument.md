...
URI: [aimsleaf:CryoEMInstrument](https://w3id.org/aims-leaf/CryoEMInstrument)
...
| [installation_date](installation_date.md) | 0..1 <br/> [Date](Date.md) | Date of instrument installation | [Instrument](Instrument.md) |
...
| ---  | ---  |
| self | aimsleaf:CryoEMInstrument |
| native | aimsleaf:CryoEMInstrument |

...
URI: [aimsleaf:MotionCorrectionParameters](https://w3id.org/aims-leaf/MotionCorrectionParameters)
...
| ---  | ---  |
| self | aimsleaf:MotionCorrectionParameters |
| native | aimsleaf:MotionCorrectionParameters |

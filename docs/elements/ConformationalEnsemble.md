...
URI: [aimsleaf:ConformationalEnsemble](https://w3id.org/aims-leaf/ConformationalEnsemble)
...
| ---  | ---  |
| self | aimsleaf:ConformationalEnsemble |
| native | aimsleaf:ConformationalEnsemble |

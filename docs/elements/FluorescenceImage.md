...
URI: [aimsleaf:FluorescenceImage](https://w3id.org/aims-leaf/FluorescenceImage)
...
| [acquisition_date](acquisition_date.md) | 0..1 <br/> [Date](Date.md) | Date image was acquired | [Image](Image.md) |
...
| ---  | ---  |
| self | aimsleaf:FluorescenceImage |
| native | aimsleaf:FluorescenceImage |

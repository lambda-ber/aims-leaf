...
URI: [aimsleaf:Instrument](https://w3id.org/aims-leaf/Instrument)
...
| [installation_date](installation_date.md) | 0..1 <br/> [Date](Date.md) | Date of instrument installation | direct |
...
| ---  | ---  |
| self | aimsleaf:Instrument |
| native | aimsleaf:Instrument |

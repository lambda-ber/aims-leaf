...
URI: [aimsleaf:BeamlineEnum](https://w3id.org/aims-leaf/BeamlineEnum)
...
| SSRL_BL143 | None | Tender X-ray Microprobe and XAS beamline at Stanford Synchrotron Radiation Li... |
| SSRL_BL23 | None | Hard X-ray Microprobe and XAS beamline at Stanford Synchrotron Radiation Ligh... |
| SSRL_BL72 | None | Lage Format XFM beamline at Stanford Synchrotron Radiation Lightsource |
| SSRL_BL62b | None | HERFD XFM beamline at Stanford Synchrotron Radiation Lightsource |
...
permissible_values:
  ...
  SSRL_BL143:
    text: SSRL_BL143
    description: Tender X-ray Microprobe and XAS beamline at Stanford Synchrotron
      Radiation Lightsource
    annotations:
      facility:
        tag: facility
      ...
      techniques:
        tag: techniques
        value: TechniqueEnum:xray_microprobe
      doe_beamline:
        tag: doe_beamline
        value: 'true'
      website:
  ...
  SSRL_BL23:
    text: SSRL_BL23
    description: Hard X-ray Microprobe and XAS beamline at Stanford Synchrotron Radiation
      Lightsource
    annotations:
      facility:
        tag: facility

...
URI: [aimsleaf:DataCollectionStrategy](https://w3id.org/aims-leaf/DataCollectionStrategy)
...
| ---  | ---  |
| self | aimsleaf:DataCollectionStrategy |
| native | aimsleaf:DataCollectionStrategy |

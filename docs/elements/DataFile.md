...
URI: [aimsleaf:DataFile](https://w3id.org/aims-leaf/DataFile)
...
| [creation_date](creation_date.md) | 0..1 <br/> [Date](Date.md) | File creation date | direct |
...
| [SampleDataAssociation](SampleDataAssociation.md) | [data_id](data_id.md) | range | [DataFile](DataFile.md) |
...
| ---  | ---  |
| self | aimsleaf:DataFile |
| native | aimsleaf:DataFile |

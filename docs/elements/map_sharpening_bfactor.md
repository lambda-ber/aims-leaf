...
URI: [aimsleaf:map_sharpening_bfactor](https://w3id.org/aims-leaf/map_sharpening_bfactor)
...
| ---  | ---  |
| self | aimsleaf:map_sharpening_bfactor |
| native | aimsleaf:map_sharpening_bfactor |

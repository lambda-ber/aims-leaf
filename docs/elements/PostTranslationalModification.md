...
URI: [aimsleaf:PostTranslationalModification](https://w3id.org/aims-leaf/PostTranslationalModification)
...
| ---  | ---  |
| self | aimsleaf:PostTranslationalModification |
| native | aimsleaf:PostTranslationalModification |
...
attributes:
  modification_type:
    ...
    from_schema: https://w3id.org/aims-leaf/functional_annotation
    rank: 1000
    domain_of:
    - PostTranslationalModification
    range: PTMTypeEnum

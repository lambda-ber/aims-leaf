...
URI: [aimsleaf:WorkflowTypeEnum](https://w3id.org/aims-leaf/WorkflowTypeEnum)
...
| xrf_analysis | None | XRF peak fitting analysis |
| ftir_analysis | None | FTIR peak fitting analysis |
| image_processing | None | image pre/post processing workflow |

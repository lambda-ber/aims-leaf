...
URI: [aimsleaf:ExperimentRun](https://w3id.org/aims-leaf/ExperimentRun)
...
```mermaid
 classDiagram
    ...
    click ExperimentRun href "../ExperimentRun/"
      ...
      ExperimentRun : beam_size_x
        
          
    
        
        
        ExperimentRun --> "0..1" QuantityValue : beam_size_x
        click QuantityValue href "../QuantityValue/"
    

        
      ExperimentRun : beam_size_y
        
          
    
        
        
        ExperimentRun --> "0..1" QuantityValue : beam_size_y
        click QuantityValue href "../QuantityValue/"
      ...
      ExperimentRun : beamline_parameters
        
          
    
        
        
        ExperimentRun --> "0..1" QuantityValue : beamline_parameters
        click QuantityValue href "../QuantityValue/"
      ...
      ExperimentRun : dwell_time
        
          
    
        
        
        ExperimentRun --> "0..1" QuantityValue : dwell_time
        click QuantityValue href "../QuantityValue/"
...
| [experiment_date](experiment_date.md) | 0..1 <br/> [Date](Date.md) | Date of the experiment | direct |
...
| [beam_size_x](beam_size_x.md) | 0..1 <br/> [QuantityValue](QuantityValue.md) | Beam size X dimension, typically specified in micrometers (µm) | direct |
| [beam_size_y](beam_size_y.md) | 0..1 <br/> [QuantityValue](QuantityValue.md) | Beam size Y dimension, typically specified in micrometers (µm) | direct |
| [dwell_time](dwell_time.md) | 0..1 <br/> [QuantityValue](QuantityValue.md) | Dwell time per pixel, typically specified in milli-seconds (ms) | direct |
| [energy](energy.md) | 0..1 <br/> [QuantityValue](QuantityValue.md) | X-ray energy, typically specified in eV | direct |
| [beamline_parameters](beamline_parameters.md) | 0..1 <br/> [QuantityValue](QuantityValue.md) | Relevant other motor positions of the beamline | direct |
...
| ---  | ---  |
| self | aimsleaf:ExperimentRun |
| native | aimsleaf:ExperimentRun |
...
attributes:
  ...
  beam_size_x:
    name: beam_size_x
    description: Beam size X dimension, typically specified in micrometers (µm). Data
  ...
  beam_size_y:
    name: beam_size_y
    description: Beam size Y dimension, typically specified in micrometers (µm). Data
      providers may specify alternative units (e.g., Angstroms) by including the unit
      in the QuantityValue.
    from_schema: https://w3id.org/aims-leaf/
    rank: 1000
  ...
  dwell_time:
    name: dwell_time
    description: Dwell time per pixel, typically specified in milli-seconds (ms).
      Data providers may specify alternative units by including the unit in the QuantityValue.
    from_schema: https://w3id.org/aims-leaf/
    rank: 1000
    domain_of:
  ...
  energy:
    name: energy
    description: X-ray energy, typically specified in eV. Data providers may specify
    ...
    inlined: true
  beamline_parameters:
    name: beamline_parameters
    description: Relevant other motor positions of the beamline
    from_schema: https://w3id.org/aims-leaf/
    rank: 1000
    domain_of:
    - ExperimentRun

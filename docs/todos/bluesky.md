...
This document tracks integration work to enable interoperability between aims-leaf and the Bluesky event-model.
...
- [ ] Python utility: databroker → aims-leaf YAML export
- [ ] Python utility: aims-leaf → Bluesky documents (for replay)
- [ ] Integration with tiled for serving aims-leaf data

## Entity Mapping Reference

| Bluesky Document | aims-leaf | Notes |
|------------------|-------------------|-------|
...
Bluesky's event model is inherently streaming/event-based, while aims-leaf is more run-based. Consider:

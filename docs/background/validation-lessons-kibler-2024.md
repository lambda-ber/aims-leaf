# Lessons Learned: Validating Real-World Data with aims-leaf

## Case Study: Kibler et al. 2024 - Pseudosymmetric Protein Hetero-oligomers

This document captures lessons learned from annotating a real scientific paper (Kibler et al., Nature Communications 2024) using the aims-leaf LinkML schema.
...
### 2. Extended Schema
Created `aims-leaf-extended.yaml`:
...
The aims-leaf schema successfully captures the core structure of multi-technique structural biology experiments. However, real-world data requires:

...
This directory contains alignment analyses and comparisons between aims-leaf and other major data standards in structural biology.

## Available Analyses

### [NeXus Alignment](nexus.md)
Analysis of how aims-leaf aligns with the NeXus data format, the international standard for neutron, X-ray, and muon science. This document covers:
- Structural mapping between NeXus and aims-leaf concepts
...
- Mapping between EMDB XML schema and aims-leaf
...
Practical guide to PDB deposition workflow and how aims-leaf relates to the process:
...
1. **Position aims-leaf** within the broader structural biology data landscape
...
All analyzed standards are complementary to aims-leaf rather than competitive:
...
- **OneDep** is the wwPDB deposition portal where metadata from aims-leaf ultimately feeds
...
- **aims-leaf** provides comprehensive workflow tracking and multi-modal integration

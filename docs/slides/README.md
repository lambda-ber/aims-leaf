...
This directory contains presentation slides in Markdown format demonstrating aims-leaf capabilities and use cases.
...
**Description**: Comprehensive presentation demonstrating the complete crystallographic workflow for hen egg white lysozyme structure determination using sulfur-SAD phasing. Shows how aims-leaf captures all metadata from crystallization through structure deposition.
...
- aims-leaf validation and benefits
...
Slides are distributed under the same license as the aims-leaf project.

...
A Survey of Relevant Ontologies and Their Coverage for aims-leaf
...
**Contact**:
- aims-leaf repository: https://github.com/lambda-ber/aims-leaf
- Issues: https://github.com/lambda-ber/aims-leaf/issues

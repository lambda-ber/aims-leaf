...
### 2. **Validation**
```bash
$ linkml-validate -s aims_leaf_ber_schema.yaml dataset-9B7F.yaml
✓ No issues found
```
...
```python
from aims_leaf_schema import Dataset, ExperimentRun
...
### Code & Documentation:
- **aims-leaf**: https://github.com/lambda-ber/aims-leaf
- **NSLS2-BER-LAMBDA**: https://github.com/NSLS2/BER-LAMBDA
- **Schema Documentation**: https://w3id.org/aims-leaf/
...
- Comprehensive metadata integration (NSLS2 ↔ aims-leaf)
...
4. Contribute to the schema: https://github.com/lambda-ber/aims-leaf
...
└─ Complete metadata in aims-leaf format
```

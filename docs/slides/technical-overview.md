...
## aims-leaf Architecture

Located at: `src/aims_leaf_schema/schema/aims_leaf_ber_schema.yaml`

```yaml
id: https://w3id.org/lambda-ber/aims-leaf
name: aims-leaf
...
uv run gen-project \
  ...
  src/aims_leaf_schema/schema/aims_leaf_ber_schema.yaml \
  -d assets
```
...
1. **Python**: Dataclasses (`assets/aims-leaf.py`)
...
```python
from aims_leaf_schema import Sample, MolecularComposition
...
uv run linkml-validate \
  -s src/aims_leaf_schema/schema/aims_leaf_ber_schema.yaml \
  tests/data/valid/Sample-protein.yaml

# Or using JSON Schema directly
jsonschema -i data.json assets/jsonschema/aims-leaf.json
```
...
```
aims-leaf/
├── src/aims_leaf_schema/
│   ├── schema/
│   │   └── aims-leaf.yaml    # Source schema
│   └── datamodel/
...
```
assets/
├── aims-leaf.py              # Python dataclasses
├── jsonschema/
│   └── aims-leaf.json
...
git clone https://github.com/lambda-ber/aims-leaf.git
cd aims-leaf
...
1. **Edit schema**: Modify `src/aims_leaf_schema/schema/aims_leaf_ber_schema.yaml`
...
**Files**: `kebab-case` (e.g., `aims-leaf.yaml`)
...
```python
import pytest
from aims_leaf_schema import Sample
...
**This Project**:
- GitHub: https://github.com/lambda-ber/aims-leaf
...
**aims-leaf**: Structured metadata for structural biology

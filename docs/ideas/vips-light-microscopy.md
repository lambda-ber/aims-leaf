...
## Relationship to aims-leaf

### Current Scope

aims-leaf focuses on molecular/atomic resolution structural biology:
- Cryo-EM
...
**Current assessment**: Out of scope for core aims-leaf

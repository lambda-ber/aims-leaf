...
This document describes the integration of metadata mappings from the NSLS2-BER-LAMBDA project into aims-leaf. The integration extends the schema to comprehensively support X-ray crystallography workflows with detailed mappings to CBF diffraction images, PDB/mmCIF depositions, and Excel metadata templates.
...
1. **Bidirectional mapping**: NSLS2 metadata can be extracted from CBF/PDB files and mapped to aims-leaf, or aims-leaf data can be exported in NSLS2 formats
...
The NSLS2-BER-LAMBDA repository can now use aims-leaf as its output format:

```python
# Pseudocode integration
from aims_leaf_schema import Dataset, ExperimentRun, WorkflowRun
...
4. Create automated converters between NSLS2 spreadsheets and aims-leaf
5. Integration with PDB deposition APIs

## References

- NSLS2-BER-LAMBDA: https://github.com/NSLS2/BER-LAMBDA
- aims-leaf: https://w3id.org/aims-leaf/
...
- aims-leaf: See repository documentation
